...
public class Request {
	...
	private void parseRequestInfo() {
		...
		/**
		 * ===================================================
		 * 从信息的首行分析出：请求方式，请求路径，请求参数（get可能有）
		 * 	如：GET /index.html?name=root&password=1988ljw
		 * 
		 * 如果为post方式，请求参数则在正文中
		 * 
		 * 
...
//		String paramString="uname=&pwd=123&fav=1&fav=2";
//		new Request().paramParams(paramString);
//	}
//	
